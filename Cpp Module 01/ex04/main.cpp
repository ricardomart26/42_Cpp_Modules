...
std::string	replace_strings(std::string line, std::string s2, int pos, int len_s1)
{
	int			i;
	std::string	ret;
	int			x;
...
void	replace_strings_in_file(const std::string filename, std::string s1, std::string s2)
{
